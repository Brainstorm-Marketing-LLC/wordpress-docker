...
EOPHP
	...
	wp core install --title=BrainstormWebsite --url=https://www.brainstormsite.com --admin_email=support@itsbrainstorming.com --admin_user=support@itsbrainstorming.com --admin_password=kc6jabsmc --allow-root
